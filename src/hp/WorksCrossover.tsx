...
export default function WorksCrossover() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F5F0]">
      {/* NAV */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-[#F8F5F0]/95 backdrop-blur-sm border-b border-[#4A6741]/10">
        <div className="max-w-6xl mx-auto px-6 py-4 flex justify-between items-center">
          <a href="/studio" className="font-['Cormorant_Garamond'] font-light text-base tracking-[3px] text-[#4A6741] no-underline">
            記憶荘 STUDIO
          </a>
          <div className="flex gap-7">
            <a href="/studio/works" className="font-['Cormorant_Garamond'] font-light text-[13px] tracking-[2px] text-[#888] hover:text-[#4A6741] transition-colors no-underline">Works</a>
            <a href="/studio/pricing" className="font-['Cormorant_Garamond'] font-light text-[13px] tracking-[2px] text-[#888] hover:text-[#4A6741] transition-colors no-underline">Pricing</a>
            <a href="/studio/about" className="font-['Cormorant_Garamond'] font-light text-[13px] tracking-[2px] text-[#888] hover:text-[#4A6741] transition-colors no-underline">About</a>
            <a href="/" className="font-['Cormorant_Garamond'] font-light text-[13px] tracking-[2px] text-[#888] hover:text-[#4A6741] transition-colors no-underline">&larr; Group</a>
          </div>
        </div>
      </nav>
      ...
      <footer className="bg-[#4A6741] text-white/50 text-center py-10 px-6 text-xs tracking-[1px]">
        <div className="mb-4 space-x-8">
          <a href="/studio" className="text-white/50 hover:text-white/80 no-underline">Top</a>
          <a href="/studio/works" className="text-white/50 hover:text-white/80 no-underline">Works</a>
          <a href="/studio/pricing" className="text-white/50 hover:text-white/80 no-underline">Pricing</a>
          <a href="/studio/about" className="text-white/50 hover:text-white/80 no-underline">About</a>
          <a href="/" className="text-white/50 hover:text-white/80 no-underline">← Group</a>
        </div>
        <div>© 2026 記憶荘 Studio</div>
      </footer>
    </div>
  );
}
