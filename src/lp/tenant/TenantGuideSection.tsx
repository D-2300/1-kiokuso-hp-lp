...
const losses = [
  { text: "仲介手数料20万円以上を払っている", amount: "20万円〜" },
  { text: "フリーレント交渉せず家賃2ヶ月分を損", amount: "40万円〜" },
  { text: "敷金6ヶ月のまま交渉せず契約", amount: "80万円〜" },
  { text: "原状回復で退去時に想定外の請求", amount: "数百万円" },
  { text: "造作譲渡料を言い値で払っている", amount: "数十万円" },
];
  ...
  return (
    <section style={{ background: "#fff", padding: "56px 24px 48px" }}>
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        {/* Single guide card - 不動産攻略ガイド */}
        <div
          style={{
            background: "rgba(107,58,80,0.06)",
            borderRadius: "16px",
            padding: "32px 24px",
            border: "1px solid rgba(107,58,80,0.2)",
            marginBottom: "28px",
          }}
        >
          <p
          ...
          <div style={{ textAlign: "center", marginBottom: "24px" }}>
            <img
              ...
              style={{
                ...
                display: "block",
                margin: "0 auto",
                filter: "drop-shadow(0 4px 16px rgba(107,58,80,0.2))",
              }}
            />
          </div>
