  ...
  return (
    <section style={{ padding: "44px 20px 36px", background: "#fff" }}>
      <div style={{ maxWidth: "720px", margin: "0 auto" }}>
        ...
        <h2 style={{ fontSize: "clamp(17px, 3.4vw, 22px)", fontWeight: 700, color: "#1a1f14", textAlign: "center", marginBottom: "6px", lineHeight: 1.55 }}>
          なぜ<span style={{ color: "#4A6741" }}>記憶荘</span>に物件情報が集まるのか？
        </h2>
        <p style={{ textAlign: "center", fontSize: "clamp(11px, 2vw, 13px)", color: "#888", marginBottom: "20px" }}>
        ...
        <div style={{
          ...
          <div style={{ textAlign: "center", flexShrink: 0 }}>
            <div style={{
              ...
              border: "2px solid #C9A84C", margin: "0 auto 4px",
            }}>
              <img src="/images/about-kai-sm.webp" alt="KAI"
                style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
            <div style={{ fontSize: "11px", fontWeight: 900, color: "#222" }}>KAI</div>
            <div style={{ fontSize: "9px", color: "#888", lineHeight: 1.3 }}>元不動産業</div>
          </div>
          ...
          <div style={{
            ...
            <img src="/assets/logos/logo-studio-dark.webp" alt="記憶荘ロゴ"
              style={{ width: "24px", height: "24px", objectFit: "contain", marginBottom: "2px", filter: "brightness(0) invert(1)" }} />
            <span style={{ fontSize: "13px", fontWeight: 900, letterSpacing: "0.04em" }}>記憶荘</span>
          </div>
          ...
          <div style={{ textAlign: "center", flexShrink: 0 }}>
            <div style={{
              width: "48px", height: "48px", borderRadius: "50%", overflow: "hidden",
              border: "2px solid #4A6741", margin: "0 auto 4px",
            }}>
              <img src="/images/about-ken-sm.webp" alt="KEN"
                style={{ width: "100%", height: "100%", objectFit: "cover" }} />
            </div>
            <div style={{ fontSize: "11px", fontWeight: 900, color: "#222" }}>KEN</div>
            <div style={{ fontSize: "9px", color: "#888", lineHeight: 1.3 }}>大工歴20年+</div>
          </div>
        </div>
        ...
        <div style={{
          ...
          {sources.map((s) => (
            <div key={s.name} style={{
              ...
              <div style={{
                width: "32px", height: "32px", borderRadius: "50%", background: s.bg,
                display: "flex", alignItems: "center", justifyContent: "center", fontSize: "16px",
              }}>
                {s.emoji}
              </div>
              <div style={{ fontSize: "clamp(10px, 2vw, 12px)", fontWeight: 700, color: "#1a1a1a", lineHeight: 1.3 }}>
                {s.name}
              </div>
              <span style={{
                fontSize: "9px", fontWeight: 600, color: "#4A6741",
        ...
        <div style={{
          ...
          <p style={{ fontSize: "clamp(13px, 2.5vw, 16px)", fontWeight: 900, lineHeight: 1.5 }}>
            <span style={{ color: "#A8BFA2" }}>物件探し</span>から<span style={{ color: "#A8BFA2" }}>内装工事</span>まで、ワンストップ。
          </p>
          <p style={{ fontSize: "10px", color: "rgba(255,255,255,0.6)", marginTop: "4px" }}>
            ※物件情報の紹介は無料です。
          </p>
        </div>
      </div>
