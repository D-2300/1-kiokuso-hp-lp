    ...
    <section style={{ backgroundColor: "#fff", padding: "40px 20px" }}>
      <div style={{ maxWidth: "960px", margin: "0 auto", display: "flex", flexDirection: "column", gap: "40px" }}>
        ...
        <div>
          ...
          <p style={{ margin: "0 0 12px", fontSize: "clamp(17px, 3vw, 22px)", fontWeight: 700, color: "#333" }}>
            設計から施工まで、一気通貫で対応
          </p>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "8px" }}>
            ...
            >
              ...
              <p style={{ margin: 0, fontSize: "14px", color: "#333", lineHeight: 2, fontFamily: "monospace" }}>
                ...
                壁塗装（DIY込）… ¥45,000<br />
                電気工事 ………… ¥120,000<br />
                <span style={{ color: "#666", fontSize: "12px" }}>全項目を一行ずつ公開</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <div>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "8px" }}>
            {[
              ...
              >
                <p style={{ margin: "0 0 6px", fontSize: "16px", fontWeight: 500, color: "#4A6741" }}>
                  {card.title}
                </p>
                <p style={{ margin: 0, fontSize: "13px", color: "#888", lineHeight: 1.7 }}>{card.desc}</p>
              </div>
            ))}
          </div>
        </div>
